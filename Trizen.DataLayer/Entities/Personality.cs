...
public class Personality
{
    ...
    public virtual ICollection<PersonalityCategory> PersonalityCategories { get; set; } = [];
    public virtual ICollection<PersonalityTourType> PersonalityTourTypes { get; set; } = [];
    public virtual ICollection<PersonalityDestinationType> PersonalityDestinationTypes { get; set; } = [];
}
