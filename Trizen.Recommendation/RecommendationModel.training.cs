    ...
    public partial class RecommendationModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"TourId",inputColumnName:@"TourId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"Score",MatrixColumnIndexColumnName=@"UserId",MatrixRowIndexColumnName=@"TourId",ApproximationRank=25,LearningRate=0.15993822344875533,NumberOfIterations=177,Quiet=true}))      
